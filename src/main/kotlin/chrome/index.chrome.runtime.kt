...
external interface `T$8` {
    @nativeGetter
    operator fun get(name: String): `T$7`?
    @nativeSetter
    operator fun set(name: String, value: `T$7`)
}
...
external interface `T$27` {
    operator fun get(key: String): `T$25`?
    operator fun set(key: String, value: `T$25`?)
    var plugins: `T$26`?
        get() = definedExternally
        set(value) = definedExternally
}
...
external interface Manifest {
    ...
    var background_page: String?
        get() = definedExternally
        set(value) = definedExternally
    var chrome_settings_overrides: `T$2`?
        get() = definedExternally
        set(value) = definedExternally
    var chrome_ui_overrides: `T$4`?
        get() = definedExternally
        set(value) = definedExternally
    var chrome_url_overrides: `T$5`?
        get() = definedExternally
        set(value) = definedExternally
    var commands: `T$8`?
        get() = definedExternally
        set(value) = definedExternally
    var content_capabilities: `T$9`?
        get() = definedExternally
        set(value) = definedExternally
    var content_scripts: Array<`T$10`>?
        get() = definedExternally
        set(value) = definedExternally
    var content_security_policy: String?
        get() = definedExternally
    ...
    var devtools_page: String?
        get() = definedExternally
        set(value) = definedExternally
    var event_rules: Array<`T$12`>?
        get() = definedExternally
        set(value) = definedExternally
    var externally_connectable: `T$13`?
        get() = definedExternally
        set(value) = definedExternally
    var file_browser_handlers: Array<`T$14`>?
        get() = definedExternally
        set(value) = definedExternally
    var file_system_provider_capabilities: `T$15`?
        get() = definedExternally
        set(value) = definedExternally
    var homepage_url: String?
        get() = definedExternally
        set(value) = definedExternally
    var import: Array<`T$16`>?
        get() = definedExternally
        set(value) = definedExternally
    var export: `T$17`?
        get() = definedExternally
    ...
    var incognito: String?
        get() = definedExternally
        set(value) = definedExternally
    var input_components: Array<`T$18`>?
        get() = definedExternally
        set(value) = definedExternally
    var key: String?
        get() = definedExternally
    ...
    var permissions: Array<String>?
        get() = definedExternally
        set(value) = definedExternally
    var platforms: Array<`T$23`>?
        get() = definedExternally
        set(value) = definedExternally
    var plugins: Array<`T$24`>?
        get() = definedExternally
        set(value) = definedExternally
    var requirements: `T$27`?
        get() = definedExternally
        set(value) = definedExternally
    var sandbox: `T$28`?
        get() = definedExternally
...
//external fun getPackageDirectoryEntry(callback: (directoryEntry: DirectoryEntry) -> Unit)
