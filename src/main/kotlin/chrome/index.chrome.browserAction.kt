...
external interface BadgeBackgroundColorDetails {
    var color: dynamic /* String | dynamic */
...
external fun getBadgeBackgroundColor(details: TabDetails, callback: (result: dynamic /* JsTuple<Number, Number, Number, Number> */) -> Unit)
