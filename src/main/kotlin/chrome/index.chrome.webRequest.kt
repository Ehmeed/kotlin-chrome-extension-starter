...
external interface WebRequestBodyEvent : Event<(details: WebRequestBodyDetails) -> dynamic> {
    fun addListener(callback: (details: WebRequestBodyDetails) -> dynamic, filter: RequestFilter = definedExternally, opt_extraInfoSpec: Array<String> = definedExternally)
}

external interface WebRequestHeadersSynchronousEvent : Event<(details: WebRequestHeadersDetails) -> dynamic> {
    fun addListener(callback: (details: WebRequestHeadersDetails) -> dynamic, filter: RequestFilter = definedExternally, opt_extraInfoSpec: Array<String> = definedExternally)
}
...
external interface WebResponseHeadersEvent : Event<(details: WebResponseHeadersDetails) -> dynamic> {
    fun addListener(callback: (details: WebResponseHeadersDetails) -> dynamic, filter: RequestFilter = definedExternally, opt_extraInfoSpec: Array<String> = definedExternally)
}
